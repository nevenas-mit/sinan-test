...
data = {'AutoScaleOpt': [45.5, 53.375, 60.375, 61.25, 63.875, 65.625, 67.375, 71.75, 84.0], 
        ...
        'Sinan': [34.125, 42.0, 51.625, 54.25, 56.0, 56.875, 63.0, 65.625, 69.125], 
        'Sinan+Dist': [35.875, 42.0, 40.25, 50.75, 56.0, 57.75, 64.75, 68.25, 68.25], 
        'Sinan+CP': [32.375, 40.25, 49.875, 51.625, 53.375, 53.375, 57.75, 60.375, 63.0], 
        'BNN':                [33.250, 42.875, 50.8, 52.50, 54.250, 54.250, 60.375, 63.0, 66.5], 
        'Dec. Tree':          [32.375, 40.125, 52.0, 54.75, 53.375, 52.375, 59.875, 65.5, 67.0],
        'Dec. Tree+Thresh.':  [34.375, 45.125, 54.0, 53.75, 58.375, 61.375, 66.875, 65.5, 69.0],
        'Dec. Tree+BNN':      [33.375, 43.125, 51.5, 53.05, 55.375, 57.375, 62.875, 63.5, 68.0]
       }
...
plt.tight_layout()
plt.savefig("sinan_resource_alloc_workshop_new.pdf")
